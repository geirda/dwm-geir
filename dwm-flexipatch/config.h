...
static char normbordercolor[]            = "#2e3036";
static char normfloatcolor[]             = "#2e3036";

static char selfgcolor[]                 = "#cac5b5";
static char selbgcolor[]                 = "#0a0a0a";
static char selbordercolor[]             = "#6b82ab";
static char selfloatcolor[]              = "#6b82ab";

static char titlenormfgcolor[]           = "#cac5b5";
static char titlenormbgcolor[]           = "#0a0a0a";
static char titlenormbordercolor[]       = "#2e3036";
static char titlenormfloatcolor[]        = "#cac5b5";

static char titleselfgcolor[]            = "#cac5b5";
static char titleselbgcolor[]            = "#0a0a0a";
static char titleselbordercolor[]        = "#0a0a0a";
static char titleselfloatcolor[]         = "#0a0a0a";

static char tagsnormfgcolor[]            = "#808080";
static char tagsnormbgcolor[]            = "#0a0a0a";
static char tagsnormbordercolor[]        = "#3a3436";
static char tagsnormfloatcolor[]         = "#db8fd9";

static char tagsselfgcolor[]             = "#cac5b5";
static char tagsselbgcolor[]             = "#3a3436";
static char tagsselbordercolor[]         = "#0a0a0a";
static char tagsselfloatcolor[]          = "#0a0a0a";
...
static const Key keys[] = {
	...
	#if RIODRAW_PATCH
	{ Mod1Mask|ControlMask,         XK_p,          riospawnsync,           {.v = dmenucmd } },
	{ Mod1Mask|ControlMask,         XK_Return,     riospawn,               {.v = termcmd } },
