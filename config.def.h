...
static const char col_gray4[]       = "#cac5c1";
...
static const char *dmenucmd[]   = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray2, "-sf", col_gray4, "-h", "24", "-p", "dmenu:", NULL };
